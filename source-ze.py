...
p5 = types.InlineKeyboardButton(text = "🔱 ᯓ 「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾",url="t.me/T_Y_E_X")
...
في قائمة المطاية اصبح مطي جديد*""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
	...
	if m == ".":
		f2 = message.from_user.first_name
		p3 = types.InlineKeyboardMarkup()
		p5 = types.InlineKeyboardButton(text = "ᯓ 「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾」، ⦃𓏛",url="t.me/T_Y_E_X")
		p3.add(p5)
...
نوع الحيوان : {}*""".format(f2,t2,r222,d222),disable_web_page_preview=True,parse_mode="markdown")
	if message.text == "السورس" or message.text == "سورس":
	    url = ["https://telegra.ph/file/04b2f1f1c808dc49db35b.jpg","https://telegra.ph/file/04b2f1f1c808dc49db35b.jpg","https://telegra.ph/file/04b2f1f1c808dc49db35b.jpg","https://telegra.ph/file/04b2f1f1c808dc49db35b.jpg"]
	    p3 = types.InlineKeyboardMarkup()
	    e3 = types.InlineKeyboardButton(text = "قناة السورس .",url="t.me/T_Y_E_X")
	    e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/IIUll_l")
	    p3.add(e3,e4)
	    r = random.choice(url)
	    h = """اهلا بك عزيزي في سورس عفرتو
[قناة السورس .](t.me/T_Y_E_X)
[مطور السورس .](t.me/IIUll_l)"""
...
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown",reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "ᯓ 「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾」، ⦃𓏛",url="t.me/T_Y_E_X")
	p3.add(p5)
...
- - - -- - - - - -- - - - -
CH - @T_Y_E_X*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "ᯓ 「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾」، ⦃𓏛",url="t.me/T_Y_E_X")
	p3.add(p5)
...
{l}*""",parse_mode="markdown")
	...
	if message.text == "ذ" or message.text == "ذكر" or message.text == "ايه" or message.text == "اية" or message.text == "اذكار":
	  p3 = types.InlineKeyboardMarkup()
	  p5 = types.InlineKeyboardButton(text = "「𝚂𝙾𝚞𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾",url="t.me/T_Y_E_X")
